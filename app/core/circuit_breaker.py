...
class CircuitBreaker:
    ...
    async def _transition_to_open(self):
        ...
        logger.warning("circuit_breaker_opened", name=self.name, failure_threshold=self.failure_threshold)
    ...
    async def _transition_to_closed(self):
        ...
        logger.info("circuit_breaker_closed", name=self.name, previous_state=previous_state.value)
    ...
    async def _transition_to_half_open(self):
        ...
        logger.info("circuit_breaker_half_open", name=self.name, recovery_timeout=self.recovery_timeout)
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "time_in_current_state": (datetime.utcnow() - self._last_state_change).total_seconds(),
        }
...
class CircuitBreakerManager:
    ...
    async def reset_all(self):
        ...
        async with self._lock:
            ...
            logger.info("circuit_breakers_reset", count=len(self._breakers))
